...
missing or byte-divergent copy. The IR alone verifies all five wire identities and its
authored adapter is now smaller than the alternatives' combined 354 lines. The
decision remains to retain stable v1 and keep new contract surface frozen until
separate product evidence justifies it.
