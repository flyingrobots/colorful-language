...
- **DIST-3** The release workflow builds binary archives for `colorful` and
  `colorful-lsp`.
...
- **DIST-3a** — *Requirement:* DIST-3. *Behavior:* release archives include the
  CLI and LSP binaries plus release metadata and checksum files. *Oracle:*
