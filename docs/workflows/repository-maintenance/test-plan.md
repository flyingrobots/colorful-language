...
- **RM-14a — Duplicate mechanism refusal.** *Requirement:* RM-14. *Behavior:*
  ...
  data rows, indented code plus fenced and commented table-shaped examples,
  inline-code styling, an empty identity, invalid escaping, canonically
  ...
  heading, table, or mechanism, while fenced and commented examples
  immediately after the real table remain non-authoritative. The process-level
