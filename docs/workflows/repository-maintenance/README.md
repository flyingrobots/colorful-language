...
visible text on the same line. Plain text, ASCII-punctuation escapes, and inline
code are normalized to their NFC displayed identity, including table-delimiter
