...
- **Unique roadmap architecture accountability.** The offline roadmap gate now
  ...
  mechanism identities across inline styling and Unicode normalization,
  rejects malformed cells, and reports duplicates with both source-line
  addresses. One architecture decision can no longer drift through two
